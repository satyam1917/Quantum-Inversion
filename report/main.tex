...
\newcommand{\ProjectTitle}{Joint Gravity and Radiometric Forward Modeling and Geophysical Inversion}
\newcommand{\StudentName}{Satyam Mishra}
\newcommand{\RollNumber}{22EX23013}
\newcommand{\SupervisorName}{Prof. Chandrani Singh}
...
\begin{titlepage}
    ...
    \vfill
    \begin{flushleft}
    \textbf{Submitted to:} Term Project 2026\\
